...
public class TeacherController {
    ...
    public String processTeacherEditedForm(@RequestParam(required = false) Integer id,@ModelAttribute Teacher editTeacher,final RedirectAttributes redirectAttributes) {
